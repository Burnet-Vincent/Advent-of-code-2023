const unsolvedcode = `five3onelxjninenine45
...
listlines.forEach(line => {
    let i = 0;
    let firstdigit = [line.length, -1];
    while(!(line.charAt(i) >= 0 && line.charAt(i) <= 9) && i < line.length){
        i++;
    }
    if(i != line.length){
        firstdigit = [i, Number(line.charAt(i))];
    }

    let firstword = [line.length, -1];

    let index = line.indexOf("one");
    if(index != -1 && index < firstword[0]) firstword = [index, 1];
    
    index = line.indexOf("two");
    if(index != -1 && index < firstword[0]) firstword = [index, 2];
    
    index = line.indexOf("three");
    if(index != -1 && index < firstword[0]) firstword = [index, 3];
    
    index = line.indexOf("four");
    if(index != -1 && index < firstword[0]) firstword = [index, 4];
    
    index = line.indexOf("five");
    if(index != -1 && index < firstword[0]) firstword = [index, 5];
    
    index = line.indexOf("six");
    if(index != -1 && index < firstword[0]) firstword = [index, 6];
    
    index = line.indexOf("seven");
    if(index != -1 && index < firstword[0]) firstword = [index, 7];
    
    index = line.indexOf("eight");
    if(index != -1 && index < firstword[0]) firstword = [index, 8];
    
    index = line.indexOf("nine");
    if(index != -1 && index < firstword[0]) firstword = [index, 9];

    let val;
    if(firstword[0] < firstdigit[0]) val = firstword[1] * 10;
    else val = firstdigit[1] * 10;
    ...
    i = line.length-1;
    while(!(line.charAt(i) >= 0 && line.charAt(i) <= 9) && i >= 0){
        i--;
    }
    if(i != -1){
        lastdigit = [i, Number(line.charAt(i))];
    }

    let lastword = [-1, -1];

    index = -1;
    while((index = line.indexOf("one", index+1)) != -1){
        if(index > lastword[0]) lastword = [index, 1];
    }

    index = -1;
    while((index = line.indexOf("two", index+1)) != -1){
        if(index > lastword[0]) lastword = [index, 2];
    }

    index = -1;
    while((index = line.indexOf("three", index+1)) != -1){
        if(index > lastword[0]) lastword = [index, 3];
    }

    index = -1;
    while((index = line.indexOf("four", index+1)) != -1){
        if(index > lastword[0]) lastword = [index, 4];
    }

    index = -1;
    while((index = line.indexOf("five", index+1)) != -1){
        if(index > lastword[0]) lastword = [index, 5];
    }

    index = -1;
    while((index = line.indexOf("six", index+1)) != -1){
        if(index > lastword[0]) lastword = [index, 6];
    }

    index = -1;
    while((index = line.indexOf("seven", index+1)) != -1){
        if(index > lastword[0]) lastword = [index, 7];
    }

    index = -1;
    while((index = line.indexOf("eight", index+1)) != -1){
        if(index > lastword[0]) lastword = [index, 8];
    }

    index = -1;
    while((index = line.indexOf("nine", index+1)) != -1){
        if(index > lastword[0]) lastword = [index, 9];
    }

    if(lastword[0] > lastdigit[0]) val += lastword[1];
    else val += lastdigit[1];
